    ...
    return (
        <div className='lg:py-[140px] md:py-24 py-14'>
            <div className="container">
                <h1 className=" text-center font-semibold  md:text-5xl text-4xxl  text-black capitalize">What we do</h1>
                <div className="row mt-8 max-sm:hidden">
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>Kitchen Backsplash</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                    ...
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>Custom Showers</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                            <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                                <h1 className=' text-red  font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                                <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                    ...
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>Custom Flooring</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                            <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                                <h1 className=' text-red  font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                                <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                    ...
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>Large Format Tiling</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                            <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                                <h1 className=' text-red  font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                                <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                    ...
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>Wall Tiling</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                            <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                                <h1 className=' text-red  font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                                <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                    ...
                    <div className=" lg:w-1/3 px-3 mt-6 sm:w-1/2">
                        <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                            ...
                            <h3 className=' text-black font-semibold text-4xl  pt-6'>ADA Compliant Showers</h3>
                            <p className=' text-base text-black  font-normal  pt-3 '>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                            <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
