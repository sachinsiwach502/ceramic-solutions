...
const Faq = () => {
    return (
        <div className="container lg:py-[140px] md:py-20 pb-16 pt-0">
            <h1 className=" text-center font-jakarata font-semibold  md:text-5xl text-4xxl  text-black capitalize">Frequently Asked Questions</h1>
