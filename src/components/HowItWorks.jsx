            ...
            <div className="max-lg:max-w-[592px] mx-auto row justify-center">
                <div className='lg:w-5/12 px-3'>
                    <div className=' relative'>
                        <div className='max-w-[496px] h-[581px] relative z-30'> <img src={howItWorks} alt="bed room" className='w-full h-full' /></div>
                ...
                <div className="lg:w-7/12 px-3 xl:pl-10">
                    ...
                    <div className='flex items-center md:gap-6 gap-1 max-sm:flex-wrap max-sm:justify-center max-lg:justify-center'>
                        <button className="bg-red text-base md:text-xlg max-w-[173px] w-full h-[63px] text-white rounded-[56px] font-bold mt-9 border-transparent border hover:border-red hover:bg-black ease-in-out duration-300">Get a Quote</button>
