            ...
            >
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Kitchen Backsplash</h3>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Custom Showers</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Custom Flooring</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Large Format Tiling</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Wall Tiling</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>ADA Compliant Showers</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
                ...
                <SwiperSlide>
                    <div className="bg-white border border-black  border-opacity-15 rounded-3xl p-6 shadow-weDo hover:border-white ease-in-out duration-300 min-h-[100%]">
                        ...
                        <h3 className=' text-black font-jakarata font-semibold text-3xl  pt-6 text-start'>Fireplace Tiling</h3>
                        <p className=' text-base text-black  font-normal font-jakarata  pt-3 text-start'>Lörem ipsum koda astrobel: sutaveligen. Rodod bänera viliga. </p>
                        <a href="#" className='flex items-center gap-[10px] pt-6 group/edit'>
                            <h1 className=' text-red  font-jakarata font-semibold text-base hover:underline ease-in-out duration-500'>Learn more</h1>
                            <div className='w-6 group-hover/edit:translate-x-1 ease-in-out duration-500'><img src={linkArrow} alt="arrow" className='w-full' /></div>
